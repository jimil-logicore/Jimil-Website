...
<script>
	function gly_pre_list()
	{
		var x = document.getElementById('pre_value').value;
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{
				document.getElementById('gly_nav').innerHTML=xmlhttp.responseText;
			}
		}
		
		xmlhttp.open("GET","pre_gly.php?id="+x,true);
		xmlhttp.send();
		
	}function gly_nxt_list()
	{
		var x = document.getElementById('next_value').value;
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{
				document.getElementById('gly_nav').innerHTML=xmlhttp.responseText;
				$('#gly_nav').show('slide',{direction:left},600);
			}
		}
		
		xmlhttp.open("GET","next_gly.php?id="+x,true);
		xmlhttp.send();
		
	}
	function img_show(tmp)
	{
		
		var str="./img/photo_album/img_"+tmp+".jpg";
		var nm= document.getElementById(tmp).name;
		//$("#gly_show").hide("slide", {direction:"down"}, 400);
		document.getElementById("gly_show").innerHTML = "<img src='"+str+"' id='gly_img'>";
		$("#gly_show").show("slide", {direction:"up"}, 550);
		document.getElementById("show_img_nm").innerHTML = "<span id='img_title'>"+nm+"</span>";
	...
	function page_displayer(pg_nm)
	{
		  ...
		  xmlhttp.onreadystatechange=function()
	   {
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
			{
				if(pg_nm=='profile' || pg_nm=='photo_gly' || pg_nm=='portfolio')
				{
					document.getElementById("panel_display").innerHTML=xmlhttp.responseText;
				}
				else
				{
	...
	function profile_display(profile_nm)
	{
		if (window.XMLHttpRequest)
		{// code for IE7+, Firefox, Chrome, Opera, Safari
			xmlhttp=new XMLHttpRequest();
		  ...
		  xmlhttp.onreadystatechange=function()
	   {
		...
		var pg = profile_nm + ".php";
		
		xmlhttp.open("GET",pg,true);
		xmlhttp.send();
	}
	function photo_panel(profile_nm)
	{
		if (window.XMLHttpRequest)
		{// code for IE7+, Firefox, Chrome, Opera, Safari
			xmlhttp=new XMLHttpRequest();
...
<?php include_once("connection.php");?>
	...
	<center>
	<div class="container" style="width:960px; height:50%; margin-left:0px; -moz-box-shadow: 0px 4px 11px #000000; -webkit-box-shadow: 0px 4px 11px #000000; box-shadow: 0px 4px 11px #000000; ">
		...
		<div id="main_content" style="background-color:#eee; border:0px solid red;">
			<center>
					...
					<div class="view">
						...
						<div class="s1"> 
							...
							<div id="info_slide">
								...
								Visit Live Site:<a id="open_site" href="http://www.chanrakthaispa.co.nz" target="_blank"> Chan Rak Thai Spa</a>
								</div>
							</div>
				...
				<div id="photo_panel" style=" background-color:#eee;">
					<div id="panel_display" style="margin-left:0px; margin-right:0px; position:;">
					  <div id="photo_holder" style="margin-left:0px; margin-right:0px; position:; height:500px;">
